...
[![Go Report Card](https://goreportcard.com/badge/github.com/fheinfling/agentic-coop-db)](https://goreportcard.com/report/github.com/fheinfling/agentic-coop-db)
...
All key operations run via CLI inside the container (no HTTP endpoint — keys
